...
class FirestoreService {
  final CollectionReference matches = FirebaseFirestore.instance.collection('basketcomatch');
  ...
  Stream<List<MatchData>> getMatchStream() {
    return matches.orderBy('timestamp', descending: true).snapshots().map((snapshot) {
